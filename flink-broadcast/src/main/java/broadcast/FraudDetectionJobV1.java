 ...
 *
 */
public class FraudDetectionJobV1 {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<Alert> alters = streamOperator.keyBy(Transaction::getAccountId).process(new FraudDetector2()).name("fraud-detect");
